...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "create_your_account": MessageLookupByLibrary.simpleMessage("إنشاء حسابك"),
    ...
    "enter_your_confirm_password": MessageLookupByLibrary.simpleMessage(
    ...
    "enter_your_phone": MessageLookupByLibrary.simpleMessage("أدخل هاتفك"),
    ...
    "please_enter_your_confirm_password": MessageLookupByLibrary.simpleMessage(
      "يرجى إدخال تأكيد كلمة المرور",
    ),
    "please_enter_your_email": MessageLookupByLibrary.simpleMessage(
      "يرجى إدخال بريدك الإلكتروني",
    ),
    "please_enter_your_gender": MessageLookupByLibrary.simpleMessage(
      "يرجى إدخال جنسك",
    ),
    "please_enter_your_name": MessageLookupByLibrary.simpleMessage(
      "يرجى إدخال اسمك",
    ),
    "please_enter_your_national_id": MessageLookupByLibrary.simpleMessage(
      "يرجى إدخال رقم الهوية الوطنية",
    ),
    "please_enter_your_password": MessageLookupByLibrary.simpleMessage(
      "يرجى إدخال كلمة المرور",
    ),
    "please_enter_your_phone": MessageLookupByLibrary.simpleMessage(
      "يرجى إدخال هاتفك",
    ),
